// Coolcart — Play Billing (Digital Goods API) + paywall. Generated. Loaded after the app.
(function(){'use strict';
const CFG={"key":"cc_ent","event":"coolcart-pro-changed","app":"Coolcart","accent":"#2E5266","bg":"#F1F5F7","p1":"#E6EEF1","line":"#DCE6EA","ink":"#1B2B33","mut":"#5A727C","title":"Still want it in 72 hours?","sub":"Then buy it. Most days, you won’t — and Coolcart shows you exactly how much you kept.","benefits":["<b>Custom cooldown</b> — 24 hours, 72 hours, or your own rule","Running total of what you didn’t buy","Unlimited quarantined items, photo quick-add"],"plans":[{"key":"pro_yearly","name":"Annual","price":"$19.99","per":"/yr","tag":"Cancel anytime · 7-day free trial","hero":true},{"key":"pro_lifetime","name":"Lifetime","price":"$29.99","per":" once","tag":"Pay once, keep forever"},{"key":"supporter_tip","name":"Supporter","price":"$3.99","per":" tip","tag":"Back a private, no-ads app"}],"grants":{"pro_yearly":"pro","pro_lifetime":"pro","supporter_tip":"pro"}};
